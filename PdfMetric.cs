...
class PdfMetric /* Character width data for standard PDF fonts */ {

/* From Core14_AFMs.zip via https://www.adobe.com/devnet/font.html */
/* Note: tests showed the Helvetica widths for '`" (quoteleft) seem wrong, so they have been amended. */

public static short [] Times = {
...
public static short [] TimesItalic = {
...
public static short [] TimesBoldItalic = {
...
public static short [] HelveticaBold = {
...
public static short [] HelveticaOblique = {
...
public static short [] HelveticaBoldOblique = {
...
/* Note : these declarations cannot be moved to the top of the file! */
public static short [] [] CourierFamily = { null, null, null, null };
public static short [] [] TimesFamily = { Times, TimesBold, TimesItalic, TimesBoldItalic };
public static short [] [] HelveticaFamily = { Helvetica, HelveticaBold, HelveticaOblique, HelveticaBoldOblique };
